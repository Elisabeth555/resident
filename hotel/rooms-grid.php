...
<head>
    ...
    <title>Customer awareness room services management system</title>
    ...
    <main id="main">
        ...
        <section class="property-grid grid">
            <div class="container">
                <div class="row">
                    <?php
                    $sql = $link->query("SELECT r.*, h.hotel_name FROM rooms r LEFT JOIN hotel h ON h.id = r.hotel_id ORDER BY r.id DESC");
