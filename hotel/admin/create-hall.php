...
if (isset($_POST['hotel_id'])) {
    ...
    $sql = $link->query("INSERT INTO halls(hotel_id, number, price_per_hour, price_per_day, image, display_title) VALUES('$hotelId', '$number', '$pricePerHour', '$pricePerDay', '$target_file', '$displayTitle')") or die($link->error);
    if ($sql) {
