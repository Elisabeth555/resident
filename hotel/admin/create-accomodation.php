...
if (isset($_POST['name'])) {
    ...
    $sql = $link->query("INSERT INTO accomodations(name, website, location, g_photo) VALUES('$name', '$website', '$location', '$target_file')") or die($link->error);
    if ($sql) {
        $query = "INSERT INTO `accomodation_managers`(`accomodation_id`, `username`, `password`) 
