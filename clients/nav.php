                ...
                <div class="pcoded-main-container">
                    ...
                    <nav class="pcoded-navbar">
                            ...
                            <div class="pcoded-inner-navbar main-menu">
                                ...
                                <div class="pcoded-navigatio-lavel" data-i18n="nav.category.forms">Services </div>
                                <ul class="pcoded-item pcoded-left-item">
                                    <li>
                                        <div>
                                            <a class="dropdown-item" href="../rooms-grid.php">Rooms</a>
								            <a class="dropdown-item" href="../halls-grid.php">Halls</a>
								            <a class="dropdown-item" href="../yyaccomodations-grid.php">Accomodations</a>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        </nav>
<div id="popMessage" style="display: flex;
  justify-content: end;
  align-items: center;
  z-index: 200px;
  padding: 2rem;">
