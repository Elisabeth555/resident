    ...
    <main id="main">
        ...
        <section class="intro-single">
            <div class="container">
                <?php
                include "./link.php";
                $query = "SELECT * FROM rooms WHERE id = '$_GET[q]'";
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-8">
                        <div class="title-single-box">
                            <h1 class="title-single"><?php echo $room["display_title"] ?></h1>
                            <span class="color-text-a">RWF <?php echo number_format($room["price_per_hour"]) ?> - RWF <?php echo number_format($room["price_per_day"]) ?></span>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-4">
                        <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="rooms-grid.php">Rooms</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <?php echo $room["display_title"] ?>
                                </li>
                            </ol>
                        </nav>
                    </div>
                                ...
                                <div class="property-price d-flex justify-content-center foo">
                                    <div class="card-header-c d-flex">
                                        ...
                                        <div class="card-title-c align-self-center">
                                            <h5 class="title-c">RWF <?php echo number_format($room["price_per_hour"]) ?> - RWF <?php echo number_format($room["price_per_day"]) ?></h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="property-summary">
                                    ...
                                    <div class="summary-list">
                                        <ul class="list">
                                            <?php
                                            $today = date("Y-m-d");
                                            $reservationsResult = $link->query("SELECT * FROM reservations WHERE type = 'Room' AND type_id = '$_GET[q]' AND status=1");
                                            ...
                                            <li class="d-flex justify-content-between">
                                                ...
                                                <span>
                                                    <?php echo $room['price_per_hour'] ?>
                                                </span>
                                            </li>
                                            <li class="d-flex justify-content-between">
                                                <strong>Price Per Day:</strong>
                                                <span><?php echo $room['price_per_day'] ?></span>
                                            </li>
                        ...
                        <div class="property-contact">
                            <form class="form-a" action="./clients/create-reservation.php">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-1">
                                        <input type="hidden" class="form-control form-control-lg form-control-a" name="type" placeholder="Type" required readonly value="Room">
                                        <input type="hidden" class="form-control form-control-lg form-control-a" name="reserved-id" required readonly value="<?php echo $room['id']; ?>">
                                        <input type="hidden" class="form-control form-control-lg form-control-a" name="reserved-title" required readonly value="<?php echo $room['display_title']; ?>">
                                        <input type="hidden" class="form-control form-control-lg form-control-a" name="reserved-number" required readonly value="<?php echo $room['number']; ?>">
                                        <label for="exampleInputEmail1">Unit Price:</label>
                                        <div class="form-group">
                                            <input type="number" class="form-control form-control-lg form-control-a" name="unit-price" placeholder="Unit Price" required readonly onchange="setTotalPrice()" value="<?php echo $room['price_per_day'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-1">
    ...
    <script>
        function setUnitPrice() {
            ...
            if (subscription_type == "daily") {
                unit_price = <?php echo $room['price_per_day'] ?>
                // setTotalPrice();
            } else {
                unit_price = <?php echo $room['price_per_hour'] ?>
                // setTotalPrice();
            }
