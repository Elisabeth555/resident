    ...
    <main id="main">
        ...
        <section class="intro-single">
            <div class="container">
                <?php
                include "./link.php";
                $query = "SELECT * FROM houses WHERE id = '$_GET[q]'";
                                ...
                                <div class="property-price d-flex justify-content-center foo">
                                    <div class="card-header-c d-flex">
                                        ...
                                        <div class="card-title-c align-self-center">
                                            <h5 class="title-c">RWF <?php echo number_format($house["price_per_hour"]) ?> - RWF <?php echo number_format($house["price_per_day"]) ?></h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="property-summary">
                                    ...
                                    <div class="summary-list">
                                        <ul class="list">
                                            <?php
                                            $today = date("Y-m-d");
                                            $reservationsResult = $link->query("SELECT * FROM reservations WHERE type = 'House' AND type_id = '$_GET[q]' AND since <= '$today' AND until >= '$today'");
                                            ...
                                            <li class="d-flex justify-content-between">
                                                ...
                                                <span><?php echo $house['number'] ?></span>
                                            </li>
                                            <li class="d-flex justify-content-between">
                                                <strong>Number Of Rooms:</strong>
                                                <span><?php echo $house['number_of_rooms'] ?></span>
                                            </li>
                                            <li class="d-flex justify-content-between">
                                                <strong>Number Of Beds:</strong>
                                                <span><?php echo $house['number_of_beds'] ?></span>
                                            </li>
                                            <li class="d-flex justify-content-between">
                                                <strong>Price Per Hour:</strong>
                                                <span>
                                                    <?php echo $house['price_per_hour'] ?>
                                                </span>
                                            </li>
                                            <li class="d-flex justify-content-between">
                                                <strong>Price Per Day:</strong>
                                                <span><?php echo $house['price_per_day'] ?></span>
                                            </li>
                        ...
                        <div class="property-contact">
                            <form class="form-a" action="./clients/create-reservation.php">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-1">
                                        <input type="hidden" class="form-control form-control-lg form-control-a" name="type" placeholder="Type" required readonly value="House">
                                        <input type="hidden" class="form-control form-control-lg form-control-a" name="reserved-id" required readonly value="<?php echo $house['id']; ?>">
                                        <input type="hidden" class="form-control form-control-lg form-control-a" name="reserved-title" required readonly value="<?php echo $house['display_title']; ?>">
                                        <input type="hidden" class="form-control form-control-lg form-control-a" name="reserved-number" required readonly value="<?php echo $house['number']; ?>">
                                        <label for="exampleInputEmail1">Unit Price:</label>
                                        <div class="form-group">
                                            <input type="number" class="form-control form-control-lg form-control-a" name="unit-price" placeholder="Unit Price" required readonly onchange="setTotalPrice()" value="<?php echo $house['price_per_day'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-1">
