...
if (isset($_POST['login'])) {
    $email = $_POST['email'];
    $pass  = $_POST['password'];
    $sel   = $link->query("SELECT * FROM accomodation_managers WHERE username='$email' AND password='$pass'");
    $row = mysqli_fetch_array($sel);
    $emo = $row['username'];
    $passs = $row['password'];
    if ($email == $emo && $pass == $passs) {
        $selh = $link->query("SELECT * FROM accomodation_managers WHERE username='$emo'");
