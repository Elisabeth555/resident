...
<div class="row">
<?php
$sql = $link->query("SELECT * From halls where availability=1") or die("failled to fetch data");
...
<div class="card-overlay-a-content">
    ...
    <div class="card-body-a">
        ...
        <a href="halls-single.php?q=<?php echo $row["id"] ?>" class="link-a">Click here to Book
