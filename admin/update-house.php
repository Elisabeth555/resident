...
if (isset($_POST['accomodation_id'])) {
    ...
    if ($sql) {
        $_SESSION['success_message']= 'Add House Successefully';
        header("Location:houses.php");
    } else {
        $_SESSION['error_message'] = 'Add House failed!';
    }
}
?>
                    ...
                    <div class="col-lg-12 col-xl-12">
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Accomodation</label>
                                <select class="form-control" name="accomodation_id">
                                    ...
                                    ?>
                                            <option value="<?php echo $row["id"] ?>" <?php echo $row["id"] == $house["accomodation_id"] ? "selected" : "" ?>><?php echo $row["name"] ?></option>
                                    <?php
                                        }
                                    }
                                    ?>
